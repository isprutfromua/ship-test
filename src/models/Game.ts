...
export class Game {
    ...
    private _gameLoop: ReturnType<typeof setInterval> | undefined;
    ...
    start() {
        this.play();
        this._gameLoop = setInterval(() => this.play(), BOAT_GEN_TIME);
    }
    ...
    generateBoat() {
        ...
        const boat =
            Math.random() > BOAT_GEN_RANDOMNESS ? BoatFactory.getRedBoat(capacity) : BoatFactory.getGreenBoat(capacity);
