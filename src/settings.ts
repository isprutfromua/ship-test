...
export const PIER_LOAD_TIME = 5_000;
export const PIER_WIDTH = 60;
export const PIER_HEIGHT = 60;
// wall
export const WALLS: TWallSetting[] = [
    [20, 0, 10, 35],
    [20, 65, 10, 35],
];
// textures
...
export const BOAT_MARGIN = 5;
export const BOAT_GEN_RANDOMNESS = 0.4;
const BOAT_START_POS: TPointTupple = [90, 50];
export const BOAT_GEN_TIME = 8_000;
// queue
...
// global
export const GAME_TIME = 120_000;
